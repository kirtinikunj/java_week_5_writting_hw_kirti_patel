...
public class Programme_10_TubeLine {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter tube Station's Name of Zone 1 : ");
        //input wizard for user, and store his/her input as a vaiarble
        String userTubeStation = scan.nextLine();
        String catchStationName = "";

        //checking if user input is present in the list of Zone 1 Station
        ...
        //logic to find the lines names from the given input from user
